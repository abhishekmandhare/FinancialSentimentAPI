...
/// <summary>
/// Fetches crypto news from CoinTelegraph's public RSS feed.
...
/// </summary>
public class CoinTelegraphNewsSourceService(
    HttpClient httpClient,
    ILogger<CoinTelegraphNewsSourceService> logger)
    : INewsSourceService
{
    private const string FeedUrl = "https://cointelegraph.com/rss";
        ...
        CancellationToken ct = default)
    {
        ...
        {
            logger.LogWarning(ex, "Failed to fetch CoinTelegraph RSS feed for {Symbol}", symbol.Value);
            return [];
        }
    }
